...
#
# Created: Wed May 19 21:24:34 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_7.addWidget(self.opensifbtn, 0, 5, 1, 1)
        self.cancelopensifbtn = QtGui.QPushButton(self.groupBox_5)
        self.cancelopensifbtn.setObjectName("cancelopensifbtn")
        self.gridLayout_7.addWidget(self.cancelopensifbtn, 0, 6, 1, 1)
        self.openpricefixline = QtGui.QLineEdit(self.groupBox_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.openpricefixline.sizePolicy().hasHeightForWidth())
        self.openpricefixline.setSizePolicy(sizePolicy)
        self.openpricefixline.setMaximumSize(QtCore.QSize(60, 16777215))
        self.openpricefixline.setObjectName("openpricefixline")
        self.gridLayout_7.addWidget(self.openpricefixline, 0, 4, 1, 1)
        ...
        self.closepricefixline = QtGui.QLineEdit(self.groupBox_4)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.closepricefixline.sizePolicy().hasHeightForWidth())
        self.closepricefixline.setSizePolicy(sizePolicy)
        self.closepricefixline.setMaximumSize(QtCore.QSize(60, 16777215))
        self.closepricefixline.setObjectName("closepricefixline")
        self.gridLayout_8.addWidget(self.closepricefixline, 0, 4, 1, 1)
