...
#
# Created: Wed May 19 17:02:57 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pricefixbuy.setMaximumSize(QtCore.QSize(60, 16777215))
        ...
        self.gridLayout_7.addWidget(self.pushButton_2, 0, 6, 1, 1)
        self.pricefixbuy_2 = QtGui.QLineEdit(self.groupBox_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pricefixbuy_2.sizePolicy().hasHeightForWidth())
        self.pricefixbuy_2.setSizePolicy(sizePolicy)
        self.pricefixbuy_2.setMaximumSize(QtCore.QSize(60, 16777215))
        self.pricefixbuy_2.setObjectName("pricefixbuy_2")
        self.gridLayout_7.addWidget(self.pricefixbuy_2, 0, 4, 1, 1)
        self.label_9 = QtGui.QLabel(self.groupBox_5)
        self.label_9.setObjectName("label_9")
        self.gridLayout_7.addWidget(self.label_9, 0, 2, 1, 1)
        self.pricepolicybuy_2 = QtGui.QComboBox(self.groupBox_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pricepolicybuy_2.sizePolicy().hasHeightForWidth())
        self.pricepolicybuy_2.setSizePolicy(sizePolicy)
        self.pricepolicybuy_2.setMaximumSize(QtCore.QSize(60, 16777215))
        self.pricepolicybuy_2.setObjectName("pricepolicybuy_2")
        self.gridLayout_7.addWidget(self.pricepolicybuy_2, 0, 1, 1, 1)
        ...
        self.pricefixsell.setMaximumSize(QtCore.QSize(60, 16777215))
        ...
        self.gridLayout_8.addWidget(self.pushButton_3, 0, 5, 1, 1)
        self.pushButton_4 = QtGui.QPushButton(self.groupBox_4)
        self.pushButton_4.setObjectName("pushButton_4")
        self.gridLayout_8.addWidget(self.pushButton_4, 0, 6, 1, 1)
        self.pricefixsell_2 = QtGui.QLineEdit(self.groupBox_4)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pricefixsell_2.sizePolicy().hasHeightForWidth())
        self.pricefixsell_2.setSizePolicy(sizePolicy)
        self.pricefixsell_2.setMaximumSize(QtCore.QSize(60, 16777215))
        self.pricefixsell_2.setObjectName("pricefixsell_2")
        self.gridLayout_8.addWidget(self.pricefixsell_2, 0, 4, 1, 1)
        self.pricepolicysell_2 = QtGui.QComboBox(self.groupBox_4)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pricepolicysell_2.sizePolicy().hasHeightForWidth())
        self.pricepolicysell_2.setSizePolicy(sizePolicy)
        self.pricepolicysell_2.setMaximumSize(QtCore.QSize(60, 16777215))
        self.pricepolicysell_2.setObjectName("pricepolicysell_2")
        self.gridLayout_8.addWidget(self.pricepolicysell_2, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QtGui.QApplication.translate("MainWindow", "空开", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_2.setText(QtGui.QApplication.translate("MainWindow", "撤单", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_3.setText(QtGui.QApplication.translate("MainWindow", "空平", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_4.setText(QtGui.QApplication.translate("MainWindow", "撤单", None, QtGui.QApplication.UnicodeUTF8))
