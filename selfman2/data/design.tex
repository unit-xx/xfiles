...
Each SMON peer runs monitoring and maintaining tasks
mentioned above and self-management capacity of the whole
SMON is achieved. Basically, a peer can run four maintaining
...
the mechanism on other distributed platforms.  Planet-Lab
...
XXX: define long running services
