...
%Managing a distributed application involves several tasks.
%The application must be first deployed to a set of
%computers. After the application is configured and started,
%its status need to be monitored for detecting and
