...
It is possbile that a peer of new version is
...
SMON peers will converge to the newest versions eventually.
...
We use a boolean variable called livetag to control epidemic
...
\note{here}, so as to help disseminating the update to
livetag.
...
application installation package. \note{filter by machine
name?}. User can change the setting on individual machines
