...
#
# Created: Mon Oct 10 10:11:55 2011
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/ztzq.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/ztzq.ico")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.loadlogbtn.setObjectName(_fromUtf8("loadlogbtn"))
        ...
        self.geninfobtn = QtGui.QPushButton(self.tab_7)
        self.geninfobtn.setObjectName(_fromUtf8("geninfobtn"))
        self.gridLayout_11.addWidget(self.geninfobtn, 0, 0, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(967, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_11.addItem(spacerItem1, 0, 1, 1, 1)
        self.accntinfotext = QtGui.QTextEdit(self.tab_7)
        self.accntinfotext.setObjectName(_fromUtf8("accntinfotext"))
        self.gridLayout_11.addWidget(self.accntinfotext, 1, 0, 1, 2)
        self.tabWidget_2.addTab(self.tab_7, _fromUtf8(""))
        self.gridLayout_9.addWidget(self.tabWidget_2, 4, 0, 1, 11)
        ...
        self.optab.setObjectName(_fromUtf8("optab"))
        ...
        self.pricepolicybuy.setObjectName(_fromUtf8("pricepolicybuy"))
        ...
        self.buypricefixspin.setObjectName(_fromUtf8("buypricefixspin"))
        self.gridLayout_2.addWidget(self.buypricefixspin, 0, 3, 1, 1)
        self.forcecancelbuychk = QtGui.QCheckBox(self.groupBox_2)
        self.forcecancelbuychk.setObjectName(_fromUtf8("forcecancelbuychk"))
        ...
        self.label_32.setStyleSheet(_fromUtf8("color: rgb(255, 0, 0);\n"
"background-color: rgb(255, 0, 0);"))
        ...
        self.buyorder2.setStyleSheet(_fromUtf8("color: rgb(255, 0, 0);"))
        self.buyorder2.setObjectName(_fromUtf8("buyorder2"))
        ...
        self.opensifbtn.setObjectName(_fromUtf8("opensifbtn"))
        self.gridLayout_7.addWidget(self.opensifbtn, 0, 3, 1, 1)
        self.cancelopensifbtn = QtGui.QPushButton(self.groupBox_5)
        self.cancelopensifbtn.setObjectName(_fromUtf8("cancelopensifbtn"))
        ...
        self.openpricecmbox.setObjectName(_fromUtf8("openpricecmbox"))
        ...
        self.openpricefixspin.setPrefix(_fromUtf8(""))
        ...
        self.openpricefixspin.setObjectName(_fromUtf8("openpricefixspin"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/rdot.jpg")), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/grdot.jpg")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.optab.addTab(self.tab, icon1, _fromUtf8(""))
        ...
        self.pricepolicysell.setObjectName(_fromUtf8("pricepolicysell"))
        ...
        self.sellpricefixspin.setObjectName(_fromUtf8("sellpricefixspin"))
        self.gridLayout.addWidget(self.sellpricefixspin, 0, 3, 1, 1)
        self.forcecancelsellchk = QtGui.QCheckBox(self.groupBox)
        self.forcecancelsellchk.setObjectName(_fromUtf8("forcecancelsellchk"))
        ...
        self.label_33.setStyleSheet(_fromUtf8("color: rgb(85, 255, 0);\n"
"background-color: rgb(85, 255, 0);"))
        ...
        self.sellorder2.setStyleSheet(_fromUtf8("color: rgb(255, 0, 0);"))
        self.sellorder2.setObjectName(_fromUtf8("sellorder2"))
        ...
        self.closesifbtn.setObjectName(_fromUtf8("closesifbtn"))
        self.gridLayout_8.addWidget(self.closesifbtn, 0, 4, 1, 1)
        self.cancelclosesifbtn = QtGui.QPushButton(self.groupBox_4)
        self.cancelclosesifbtn.setObjectName(_fromUtf8("cancelclosesifbtn"))
        ...
        self.closepricecmbox.setObjectName(_fromUtf8("closepricecmbox"))
        ...
        self.closepricefixspin.setPrefix(_fromUtf8(""))
        ...
        self.closepricefixspin.setObjectName(_fromUtf8("closepricefixspin"))
        self.gridLayout_8.addWidget(self.closepricefixspin, 0, 3, 1, 1)
        self.gridLayout_4.addWidget(self.groupBox_4, 0, 1, 1, 1)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/gdot.jpg")), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/grdot.jpg")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.optab.addTab(self.tab_2, icon2, _fromUtf8(""))
        self.gridLayout_9.addWidget(self.optab, 0, 0, 1, 12)
        self.sifquick = QtGui.QGroupBox(self.centralwidget)
        self.sifquick.setMinimumSize(QtCore.QSize(200, 0))
        self.sifquick.setObjectName(_fromUtf8("sifquick"))
        self.gridLayout_10 = QtGui.QGridLayout(self.sifquick)
        self.gridLayout_10.setObjectName(_fromUtf8("gridLayout_10"))
        self.sifnumspin = QtGui.QSpinBox(self.sifquick)
        self.sifnumspin.setObjectName(_fromUtf8("sifnumspin"))
        self.gridLayout_10.addWidget(self.sifnumspin, 0, 0, 1, 2)
        self.sifsubmitbtn = QtGui.QPushButton(self.sifquick)
        self.sifsubmitbtn.setObjectName(_fromUtf8("sifsubmitbtn"))
        self.gridLayout_10.addWidget(self.sifsubmitbtn, 0, 2, 1, 2)
        self.sifosrad = QtGui.QRadioButton(self.sifquick)
        self.sifosrad.setChecked(True)
        self.sifosrad.setObjectName(_fromUtf8("sifosrad"))
        self.gridLayout_10.addWidget(self.sifosrad, 1, 0, 1, 1)
        self.sifcsrad = QtGui.QRadioButton(self.sifquick)
        self.sifcsrad.setObjectName(_fromUtf8("sifcsrad"))
        self.gridLayout_10.addWidget(self.sifcsrad, 1, 1, 1, 2)
        self.sifolrad = QtGui.QRadioButton(self.sifquick)
        self.sifolrad.setObjectName(_fromUtf8("sifolrad"))
        self.gridLayout_10.addWidget(self.sifolrad, 1, 3, 1, 1)
        self.label = QtGui.QLabel(self.sifquick)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout_10.addWidget(self.label, 2, 0, 1, 1)
        self.sifoidline = QtGui.QLineEdit(self.sifquick)
        self.sifoidline.setReadOnly(True)
        self.sifoidline.setObjectName(_fromUtf8("sifoidline"))
        self.gridLayout_10.addWidget(self.sifoidline, 2, 1, 1, 5)
        self.label_3 = QtGui.QLabel(self.sifquick)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout_10.addWidget(self.label_3, 3, 0, 1, 1)
        self.sifocntline = QtGui.QLineEdit(self.sifquick)
        self.sifocntline.setReadOnly(True)
        self.sifocntline.setObjectName(_fromUtf8("sifocntline"))
        self.gridLayout_10.addWidget(self.sifocntline, 3, 1, 1, 5)
        self.label_8 = QtGui.QLabel(self.sifquick)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.gridLayout_10.addWidget(self.label_8, 4, 0, 1, 1)
        self.sifdcntline = QtGui.QLineEdit(self.sifquick)
        self.sifdcntline.setReadOnly(True)
        self.sifdcntline.setObjectName(_fromUtf8("sifdcntline"))
        self.gridLayout_10.addWidget(self.sifdcntline, 4, 1, 1, 5)
        self.label_10 = QtGui.QLabel(self.sifquick)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.gridLayout_10.addWidget(self.label_10, 5, 0, 1, 1)
        self.sifstatusline = QtGui.QLineEdit(self.sifquick)
        self.sifstatusline.setReadOnly(True)
        self.sifstatusline.setObjectName(_fromUtf8("sifstatusline"))
        self.gridLayout_10.addWidget(self.sifstatusline, 5, 1, 1, 5)
        self.sifcancelbtn = QtGui.QPushButton(self.sifquick)
        self.sifcancelbtn.setObjectName(_fromUtf8("sifcancelbtn"))
        self.gridLayout_10.addWidget(self.sifcancelbtn, 0, 4, 1, 2)
        self.sifclrad = QtGui.QRadioButton(self.sifquick)
        self.sifclrad.setObjectName(_fromUtf8("sifclrad"))
        self.gridLayout_10.addWidget(self.sifclrad, 1, 4, 1, 1)
        self.gridLayout_9.addWidget(self.sifquick, 0, 12, 3, 1)
        ...
        self.stockindex.setObjectName(_fromUtf8("stockindex"))
        self.gridLayout_9.addWidget(self.stockindex, 1, 0, 1, 12)
        ...
        self.hs300line.setObjectName(_fromUtf8("hs300line"))
        ...
        self.sindexcmbox.setObjectName(_fromUtf8("sindexcmbox"))
        ...
        self.sindexline.setObjectName(_fromUtf8("sindexline"))
        ...
        self.basediffline.setObjectName(_fromUtf8("basediffline"))
        ...
        self.gridLayout_5.addItem(spacerItem4, 0, 15, 1, 1)
        ...
        self.basediffperline.setObjectName(_fromUtf8("basediffperline"))
        ...
        self.openthresholdspin.setPrefix(_fromUtf8(""))
        self.openthresholdspin.setDecimals(2)
        self.openthresholdspin.setMinimum(0.0)
        self.openthresholdspin.setMaximum(10000.0)
        self.openthresholdspin.setSingleStep(0.1)
        self.openthresholdspin.setProperty(_fromUtf8("value"), 1.5)
        self.openthresholdspin.setObjectName(_fromUtf8("openthresholdspin"))
        ...
        self.playsignalchk.setObjectName(_fromUtf8("playsignalchk"))
        ...
        self.closethresholdspin.setStyleSheet(_fromUtf8(""))
        self.closethresholdspin.setFrame(True)
        self.closethresholdspin.setButtonSymbols(QtGui.QAbstractSpinBox.UpDownArrows)
        self.closethresholdspin.setPrefix(_fromUtf8(""))
        self.closethresholdspin.setDecimals(2)
        ...
        self.closethresholdspin.setProperty(_fromUtf8("value"), 0.5)
        self.closethresholdspin.setObjectName(_fromUtf8("closethresholdspin"))
        ...
        self.highlightchk.setObjectName(_fromUtf8("highlightchk"))
        ...
        self.bostatusline.setObjectName(_fromUtf8("bostatusline"))
        self.gridLayout_9.addWidget(self.bostatusline, 3, 1, 1, 1)
        self.label_19 = QtGui.QLabel(self.centralwidget)
        self.label_19.setObjectName(_fromUtf8("label_19"))
        self.gridLayout_9.addWidget(self.label_19, 3, 2, 1, 1)
        ...
        self.buytotalline.setObjectName(_fromUtf8("buytotalline"))
        self.gridLayout_9.addWidget(self.buytotalline, 3, 3, 1, 1)
        self.label_34 = QtGui.QLabel(self.centralwidget)
        self.label_34.setObjectName(_fromUtf8("label_34"))
        self.gridLayout_9.addWidget(self.label_34, 3, 4, 1, 1)
        ...
        self.buypointline.setObjectName(_fromUtf8("buypointline"))
        self.gridLayout_9.addWidget(self.buypointline, 3, 5, 1, 1)
        self.label_18 = QtGui.QLabel(self.centralwidget)
        self.label_18.setObjectName(_fromUtf8("label_18"))
        self.gridLayout_9.addWidget(self.label_18, 3, 6, 1, 1)
        ...
        self.selltotalline.setObjectName(_fromUtf8("selltotalline"))
        self.gridLayout_9.addWidget(self.selltotalline, 3, 7, 1, 1)
        self.label_35 = QtGui.QLabel(self.centralwidget)
        self.label_35.setObjectName(_fromUtf8("label_35"))
        self.gridLayout_9.addWidget(self.label_35, 3, 8, 1, 1)
        ...
        self.sellpointline.setObjectName(_fromUtf8("sellpointline"))
        self.gridLayout_9.addWidget(self.sellpointline, 3, 9, 1, 1)
        self.label_17 = QtGui.QLabel(self.centralwidget)
        self.label_17.setObjectName(_fromUtf8("label_17"))
        self.gridLayout_9.addWidget(self.label_17, 3, 10, 1, 1)
        ...
        self.posnameline.setObjectName(_fromUtf8("posnameline"))
        self.gridLayout_9.addWidget(self.posnameline, 3, 11, 1, 2)
        ...
        self.stoppedline.setObjectName(_fromUtf8("stoppedline"))
        ...
        self.buyableline.setObjectName(_fromUtf8("buyableline"))
        ...
        self.buyedline.setObjectName(_fromUtf8("buyedline"))
        ...
        self.buywaitline.setObjectName(_fromUtf8("buywaitline"))
        ...
        self.buyfailline.setObjectName(_fromUtf8("buyfailline"))
        ...
        self.cancelbuyfailline.setObjectName(_fromUtf8("cancelbuyfailline"))
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.cancelbuyfailline)
        self.tabstat.addTab(self.tab_3, _fromUtf8(""))
        ...
        self.stoppedline_2.setObjectName(_fromUtf8("stoppedline_2"))
        ...
        self.sellableline.setObjectName(_fromUtf8("sellableline"))
        ...
        self.selledline.setObjectName(_fromUtf8("selledline"))
        ...
        self.sellwaitline.setObjectName(_fromUtf8("sellwaitline"))
        ...
        self.sellfailline.setObjectName(_fromUtf8("sellfailline"))
        ...
        self.cancelsellfailline.setObjectName(_fromUtf8("cancelsellfailline"))
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.FieldRole, self.cancelsellfailline)
        self.tabstat.addTab(self.tab_4, _fromUtf8(""))
        self.gridLayout_9.addWidget(self.tabstat, 4, 11, 1, 2)
        ...
        self.stockinfoact.setObjectName(_fromUtf8("stockinfoact"))
        self.posstatact = QtGui.QAction(MainWindow)
        self.posstatact.setObjectName(_fromUtf8("posstatact"))
        self.genbuyfromsellact = QtGui.QAction(MainWindow)
        self.genbuyfromsellact.setObjectName(_fromUtf8("genbuyfromsellact"))
        self.saveptfact = QtGui.QAction(MainWindow)
        self.saveptfact.setObjectName(_fromUtf8("saveptfact"))
        ...
        QtCore.QObject.connect(self.optab, QtCore.SIGNAL(_fromUtf8("currentChanged(int)")), self.tabstat.setCurrentIndex)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.geninfobtn.setText(QtGui.QApplication.translate("MainWindow", "refresh", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_7), QtGui.QApplication.translate("MainWindow", "账户信息", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.sifquick.setTitle(QtGui.QApplication.translate("MainWindow", "期货快捷", None, QtGui.QApplication.UnicodeUTF8))
        self.sifsubmitbtn.setText(QtGui.QApplication.translate("MainWindow", "submit!", None, QtGui.QApplication.UnicodeUTF8))
        self.sifosrad.setText(QtGui.QApplication.translate("MainWindow", "空开", None, QtGui.QApplication.UnicodeUTF8))
        self.sifcsrad.setText(QtGui.QApplication.translate("MainWindow", "空平", None, QtGui.QApplication.UnicodeUTF8))
        self.sifolrad.setText(QtGui.QApplication.translate("MainWindow", "多开", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("MainWindow", "委托号", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("MainWindow", "委托量", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setText(QtGui.QApplication.translate("MainWindow", "成交量", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setText(QtGui.QApplication.translate("MainWindow", "委托状态", None, QtGui.QApplication.UnicodeUTF8))
        self.sifcancelbtn.setText(QtGui.QApplication.translate("MainWindow", "cancel", None, QtGui.QApplication.UnicodeUTF8))
        self.sifclrad.setText(QtGui.QApplication.translate("MainWindow", "多平", None, QtGui.QApplication.UnicodeUTF8))
