...
buildOptions = dict(
        ...
        icon = "ztzq.ico",
        include_files = ["ztzq.ico", "hs300.txt", "itrader.cfg", "itrader-gw.cfg", "easytrader.cfg", "easytrader-prod.cfg", "msvcr_redist", "jsdhqdll", "openmusic", "closemusic", (backenddir(), "phonon_backend")],
        compressed = True,
        optimize = 2)
