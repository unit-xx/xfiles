...
\chapter{分布式数据分发系统的优化方法研究}
\label{chap:bt}

数据分发是分布式系统部署等应用的基础。临近邻居选择和动态上传带宽优化是
两种已知的优化分布式数据分发的方法。本章在真实Internet测量数据的基础上，
对这两种优化方法进行了广泛而深入的研究测试。从而深入了解了两种优化方法
的特性、优化方法受数据块选择方法的影响和合并两种优化的效果。对实际应用
优化方法提出了建议。
